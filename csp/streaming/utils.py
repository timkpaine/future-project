...
from ..base import StreamNone, StreamRepeat, StreamEnd, CSPException
...
def Reduce(*nodes, reducer=None, inject_node=False):
    ...
    For a full example, see csp.tests.streaming.test_utils_streaming.TestUtils
    """
...
def Subprocess(
    ...
    if node_to_command and not one_off:
        raise CSPException("Piping upstream values to command assumes one off")
