...
tests: ## Clean and Make unit tests
	python -m pytest csp --cov=csp --junitxml=python_junit.xml --cov-report=xml --cov-branch

testsci: ## Clean and Make unit tests
	CI=true python -m pytest csp --cov=csp --junitxml=python_junit.xml --cov-report=xml --cov-branch
...
lint: ## run linter
	python -m flake8 csp setup.py

fix:  ## run black fix
	python -m black csp/ setup.py
